...
```
    ...
    Result: 302 Found (Redirect to Login). Conclusion: The application uses strict domain scoping for cookies, preventing session hijacking across regional assets.
```
